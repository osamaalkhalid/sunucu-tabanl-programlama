...
?>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold text-primary">kullancı listesi</h6>
                            	</div>
                                ...
                                <table class="table table-bordered" id="user_table" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>resim</th>
                                            <th>kullancı adı</th>
                                            <th>kullancı iletişim numarası</th>
                                            <th>kullancı e posta</th>
                                            <th>kullancı şifresi</th>
                                            <th>kullancı türü</th>
    	...
    	<form method="post" id="user_form" enctype="multipart/form-data">
      		<div class="modal-content">
        		<div class="modal-header">
          			<h4 class="modal-title" id="modal_title">verileri ekle</h4>
        		...
        		<div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">kullancı adı <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">kullancı iletişim numarası <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">kullancı e-posta <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">kullancı şifresi <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">kullancı türü <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">Kullanıcı profili</label>
                            <div class="col-md-8">
...
$(document).ready(function(){
	...
	$('#add_user').click(function(){
    	...
    	$('#modal_title').text('verileri ekle');

    	$('#action').val('Add');

    	$('#submit_button').val('ekle');
	...
	$(document).on('click', '.edit_button', function(){
		...
		$.ajax({
	      	...
	      	success:function(data)
	      	{
	        	...
	        	$('#modal_title').text('verileri düzenle');

	        	$('#action').val('Edit');

	        	$('#submit_button').val('düzenle');
