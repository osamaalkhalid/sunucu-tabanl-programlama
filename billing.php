...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Fatura Yönetimi</h1>
    	...
    	<form method="post" id="billing_form">
      		<div class="modal-content">
        		<div class="modal-header">
          			<h4 class="modal-title" id="modal_title">Fatura Ayrıntıları</h4>
        		...
        		<div class="modal-footer">
          			...
          			<input type="submit" name="submit" id="submit_button" class="btn btn-success" value="tamamlandi" />
