...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Vergi Yönetimi</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold text-primary">vergi listesi</h6>
                            	</div>
    	...
    	<form method="post" id="tax_form">
      		<div class="modal-content">
        		<div class="modal-header">
          			<h4 class="modal-title" id="modal_title">veri ekle</h4>
        		...
        		<div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Vergi Yüzdesi</label>
                        <input type="text" name="tax_percentage" id="tax_percentage" class="form-control" required  data-parsley-trigger="keyup" />
                    </div>
        		</div>
