...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Tablo Yönetimi</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold text-primary">Tablo Listesi</h6>
                            	</div>
        		...
        		<div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="table_capacity" id="table_capacity" class="form-control" required data-parsley-trigger="change">
                            <option value="">Masa Kapasitesi</option>
                            <?php
                            for($i = 1; $i <= 20; $i++)
                            {
                                echo '<option value="'.$i.'">'.$i.' Kişi</option>';
                            }
                            ?>
                        </select>
                    </div>
...
$(document).ready(function(){
	...
	$(document).on('click', '.status_button', function(){
		...
		if(confirm("İstediğine emin misin "+next_status+" it?"))
    	{
