...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Ayar</h1>
                    ...
                    <form method="post" id="setting_form" enctype="multipart/form-data">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="row">
                                    <div class="col">
                                        <h6 class="m-0 font-weight-bold text-primary">Ayar</h6>
                                    </div>
                                    <div clas="col" align="right">
                                        <button type="submit" name="edit_button" id="edit_button" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i> Düzenlemek</button>
                                        &nbsp;&nbsp;
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>Logo Seçin</label><br />
                                            <input type="file" name="restaurant_logo" id="restaurant_logo" />
                                            <br />
                                            <span class="text-muted">Yalnızca .jpg, .png dosyasının yüklenmesine izin verilir</span><br />
