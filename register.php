                        ...
                        <form method="post" id="register_form">
                            <div class="p-5">
                                ...
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Hesap açmak</h1>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Restoran İletişim No.</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Restoran Etiket Satırı</label>
                                    ...
                                    <div class="col-md-12" align="center">
                                        <div class="form-group">
                                            <br />
                                            <button type="submit" name="register_button" id="register_button" class="btn btn-primary btn-user">Kurmak</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
