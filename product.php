...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">ürün yöntemi</h1>
      		...
      		<div class="modal-content">
        		...
        		<div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="product_price" id="product_price" class="form-control" required   data-parsley-trigger="keyup" />
                    </div>
        		</div>
